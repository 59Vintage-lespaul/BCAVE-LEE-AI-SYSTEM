...
## 사용법
`/research-users <리서치 데이터 또는 대상>` — 데이터를 생략하면 리 기존 페르소나 기반으로 심화 분석합니다.

## 절차

### Step 1: 리서치 인풋 수집
1. `.fpof-state.json`에서 현재 시즌과 단계 확인
2. `system/presets/lee/personas.json` 참조 — 기존 UNI/WOMAN 페르소나
3. `system/presets/lee/channels.json` 참조 — 채널별 고객 접점
4. 사용자에게 확인:

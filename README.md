...
>
> AI가 리(Lee) 브랜드의 시즌 기획부터 런칭까지를 함께 운영하는 패션 하우스 오케스트레이션 시스템입니다.
>
...
| 특징 | 설명 |
|------|------|
| **브랜드 중심** | 리 브랜드 DNA(American Denim Heritage · SENSUOUS WORKWEAR)가 모든 스킬에 내장 |
| **PDCA 워크플로우** | Plan → Design → Do → Check → Act 자동화 |
| **품질 게이트** | 각 단계 완료 시 자동 검수(QG1~QG4) |
| **자연어 라우팅** | 의도 기반 에이전시/역할/스킬 자동 매핑 |
| **65개 PM 프레임워크** | Paweł Huryn PM-Skills 리 컨텍스트로 통합 |
...
|------|------|
| **브랜드명** | 리 (Lee) |
| **라이선스** | HD Lee Company (1889, Kansas City, Kontoor Brands) → B.CAVE 국내 운영 (2021) |
| **컨셉** | SENSUOUS WORKWEAR — American Denim Heritage의 트렌드 재해석 |
| **포지셔닝** | DENIM × TRENDY — Diesel·Marithé 주변 (벤치마크: Polo·Lacoste·CK) |
| **코어 타겟** | 메인 18~29세 트렌드세터 / 서브 29~45세 헤리티지 수요자 |
| **뮤즈 2026** | NCT 재민 (남성·팬덤) + 노윤서 (여성 확장) |
| **비전** | 2029 NO.1 글로벌 데님 헤리티지 패밀리 브랜드 |
...
| **brand-guidelines** | Anthropic/리 브랜드 스타일 |
...
- [CLAUDE.md](./CLAUDE.md) — FPOF 리 시스템 상세 설정
...
**버전**: 2.2.0
**최종 업데이트**: 2026-03-09
**PM-Skills**: Paweł Huryn (MIT License) 기반 리 커스터마이징
**라이선스**: Copyright © 2026 Lee. All rights reserved.

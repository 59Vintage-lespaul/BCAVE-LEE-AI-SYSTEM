...
**변환 예시**:
- **아웃풋 (기존)**: Q2: 그래픽 티 라인 출시, 헤리티지 콜라보 3건, 무신사 전용 상품 제작
- **아웃컴 (전환)**:
  - Q2: 20대 코어타겟이 리의 SENSUOUS WORKWEAR 아이덴티티를 경험하게 하여 20대 매출 비중 +5%p 달성
  - Q2: Buddy Lee/101/Storm Rider 아카이브 재해석 상품으로 데님 카테고리 히트율을 높여 데님 매출 기여도 +8%p 확보
  - Q2: 무신사 고객이 리를 '헤리티지 재해석 브랜드'로 경험하게 하여 채널 신규 유입 40% 증대

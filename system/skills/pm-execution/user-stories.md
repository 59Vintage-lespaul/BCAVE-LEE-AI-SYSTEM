...
- 리 자사몰, 앱, 무신사 등 채널별 사용자 경험 차이를 스토리에 반영
- 고객(18~29세 트렌드세터 (메인) + 29~45세 헤리티지 수요자 (서브))의 쇼핑 행동과 기대를 기반으로 스토리 작성
...
- 스토리가 리 채널(자사몰, 무신사, 29CM 등)의 UX와 정합하는지 확인
...
**설명:** As a 리 온라인 쇼퍼, I want to 좋아하는 캐릭터(Buddy Lee, 몽몽 등)로 상품을 필터링하고 싶어서, so that 원하는 캐릭터 콜라보 상품을 빠르게 찾을 수 있다.

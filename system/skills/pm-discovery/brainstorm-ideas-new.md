...
## FPOF 컨텍스트
- 이 스킬은 리의 시즌 기획(Plan 단계)에서 신규 카테고리/라인/IP 콜라보 아이디어를 발굴하는 데 활용합니다
...
- 리의 어떤 전략적 목표에 연결되는가?
- 코어 타겟(18~29세 트렌드세터 (메인) + 29~45세 헤리티지 수요자 (서브))의 어떤 니즈를 해결하는가?
- 기존 카테고리와의 차별점은?
...
- 5대 경영목표와의 연결점
- IP 캐릭터(Buddy Lee, Storm Rider, Lee 101, Lazy S, Union-Alls) 활용 기회

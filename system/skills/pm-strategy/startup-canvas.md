...
## FPOF 컨텍스트
- 이 스킬은 리 브랜드의 신규 사업(IP 라이선싱, 글로벌 진출, 신규 카테고리 등) 전략 수립에 활용합니다

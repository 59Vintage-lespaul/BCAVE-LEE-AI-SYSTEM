...
> Geoffrey Moore의 "Crossing the Chasm" 비치헤드 전략을 FPOF 패션 하우스 컨텍스트에 맞게 커스터마이징 -- 리의 글로벌 확장 시 첫 번째 공략 시장 선정에 활용
...
## FPOF 컨텍스트
- 이 스킬은 리 브랜드의 글로벌 확장(5대 경영목표 중 "글로벌 대응 강화") 및 신규 카테고리 런칭에 활용합니다
...
- 경쟁 환경과 포지셔닝
- 리의 차별화 요소 (Denim Heritage, Heritage Archive)
- 유통 접근성 (채널 전략)
- 소요 시간과 리소스
- 시장 성장세와 모멘텀

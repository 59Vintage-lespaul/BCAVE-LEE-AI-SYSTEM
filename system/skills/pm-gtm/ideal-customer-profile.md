...
> Jobs to Be Done 이론 기반 고객 프로파일링 -- 리의 코어 타겟을 더 세밀하게 정의 (personas.json 기반 확장)

## 언제 사용
- 리의 ICP를 리서치/서베이 데이터 기반으로 정의할 때
...
## FPOF 컨텍스트
- 이 스킬은 리 브랜드의 코어 타겟을 personas.json 기반으로 확장/정밀화하는 데 활용합니다

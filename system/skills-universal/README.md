...
│   └── brand-styler.md     ← 리 브랜드 적용 가이드 (brand-guidelines 어댑터)
└── bridges/
...
| `brand-styler` | **리 브랜드** 적용 (WW 전용) | `adapters/brand-styler.md` |
...
|------|-----------------------------------|-----------------------------|
| 대상 | 어떤 AI/프로젝트에서도 사용 가능 | 리 브랜드 & FPOF 워크플로우 전용 |
| 트리거 | 자연어 → `nl-triggers.md` 매핑 | PDCA 단계 + 에이전시 라우팅 |
| 산출물 | 범용 문서/코드/비주얼 | 브랜드 정체성 기반 패션 실무 산출물 |
| 브랜드 | 없음 (또는 `brand-styler`로 WW 적용) | 리 DNA 내장 |

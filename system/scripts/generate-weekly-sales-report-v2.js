...
pres.author = "Lee";
pres.title = "Lee Weekly Sales Report";
...
cover.addText("Lee Weekly Sales Report", {
  x: 0.75,
  y: 1.2,
  w: 8.9,
  h: 0.7,
...
metricCard(cover, 3.65, 3.0, 2.8, 1.7, "리", "43억", "목표 45억 대비 95%", C.amber);
...
metricCard(s2, 3.6, 1.55, 2.8, 1.55, "리", "43억", "YoY -4%", C.red);

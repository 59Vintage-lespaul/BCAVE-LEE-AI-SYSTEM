...
const features = [
  ...
  { icon: "🎨", title: "브랜드 보이스 보장", desc: "리 DNA, 톤앤매너\n사전 세팅. 모든 결과물이\n브랜드에 맞음", color: C.orange },
];
...
s6.addText([
  ...
  { text: '구체적으로 말할수록 좋습니다 — "Buddy Lee 캐릭터를 활용한 유니섹스 그래픽 티셔츠 디자인해줘. 타겟은 18~22세, 데님 헤리티지 감성으로"', options: { color: C.textMuted } },
], {
...
const champs = [
  { num: "1", name: "Buddy Lee 그래픽 티 (Carry-over)" },
...
s14.addText("📋 무드보드: Buddy Lee 그래픽 티", {
...
const topProducts = [
  { num: "1", name: "Buddy Lee 그래픽 티", val: "1.5억 (18%)" },
...
s30.addText("Lee Fashion House — American Denim Heritage reinterpreted for today", {
...
// WRITE FILE
// =========================================
pres.writeFile({ fileName: "/Users/sherman/07. FPOF V2.2 Claude/docs/lee-user-manual.pptx" })

...
**디자인 컨셉**: American Denim Heritage reinterpreted for today
**코어 타겟**: 18~29세 트렌드세터 + 29~45세 헤리티지 수요자
**비전**: 글로벌 데님 헤리티지 패밀리 브랜드 (2029 NO.1 글로벌 데님 헤리티지 패밀리 브랜드)
**뮤즈**: NCT 재민 (글로벌 팬덤) · 노윤서 (여성 확장)
...
4. **타겟 매치** (18~29세 트렌드세터가 좋아할 이미지인가)
...
def main():
    parser = argparse.ArgumentParser(
        description="Lee Brand Fit Filter — Claude Vision"
    )

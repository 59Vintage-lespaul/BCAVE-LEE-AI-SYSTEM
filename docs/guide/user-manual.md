...
> 리 패션 하우스 AI 오케스트레이션 시스템 종합 레퍼런스

---

## 1. 시스템 개요

FPOF(Fashion PDCA Orchestration Framework)는 패션 브랜드 **리(Lee)**의 시즌 운영을 AI와 함께 수행하는 시스템입니다.
...
├── .gitignore
│
├── presets/lee/         ← 브랜드 지식 베이스 (7개 JSON)
...
│   └── ip-bible.json            Buddy Lee+11 캐릭터 세계관
│
├── agents/                      ← 6개 에이전시 (팀 정의)
...
| **ip-bible.json** | Buddy Lee+11 캐릭터, 성격, 그룹, 관계도, 활용 가이드 | IP 활용 디자인, 스토리텔링 |

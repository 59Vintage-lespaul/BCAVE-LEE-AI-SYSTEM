...
```json
{
  "text": ["리", "WACKY WILLY", "2026 S/S COLLECTION"],
...
```bash
# 긍정 예시
./ane_tool sentiment "이번 시즌 리 컬렉션 진짜 예쁘다"

# 부정 예시
./ane_tool sentiment "디자인은 괜찮은데 소재가 좀 아쉽네요"

# 중립 예시
./ane_tool sentiment "리 매장이 성수에 있습니다"
```

**예상 출력:**
```json
{
  "text": "이번 시즌 리 컬렉션 진짜 예쁘다",
  "score": 0.85,
  "label": "positive"
}
```

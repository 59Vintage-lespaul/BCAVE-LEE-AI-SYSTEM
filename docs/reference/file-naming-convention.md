...
> 리 패션 하우스 시스템의 모든 산출물에 적용되는 파일명·폴더명 표준 규칙
...
| `YYYY.MM.DD` | `2026.03.04 리 주간리뷰 대시보드.html` | 비표준 |
...
| 공백 ` ` | `2026.03.04 리 사업부 주간리뷰 요약보고.md` |

### 1-3. 한글/영문 파일명 혼용
- 영문: `plan_strategy-summary.md`
- 한글: `리 소싱 팀장 지원자 면접 요약 보고서.md`
...
- 본문 내 `v2`: `2026.03.04 리 주간리뷰 v2.html`
...
| Before | After |
|--------|-------|
| `weekly review/w9/2026.03.04 리 사업부 주간리뷰 요약보고.md` | `26SS/weekly/w09/review_dept-summary_2026-03-04.md` |
| `weekly review/w9/2026.03.04 리 주간리뷰 임원보고.pptx` | `26SS/weekly/w09/deck_exec-report_2026-03-04.pptx` |
| `weekly review/w9/2026.03.04 리 주간리뷰 임원보고.pdf` | `26SS/weekly/w09/report_exec_2026-03-04.pdf` |
| `weekly review/w9/2026.03.04 리 주간리뷰 대시보드.html` | `26SS/weekly/w09/board_dashboard_2026-03-04.html` |
...
| `meeting/리 소싱 팀장 지원자 면접 요약 보고서.md` | `26SS/weekly/w09/meeting_sourcing-interview-summary.md` |
...
| `dashboard/lee-dashboard.html` | `26SS/dashboard/board_sales.html` |
